...
import CardFeasibilityStudySelect from "@/components/myprofile-sections/my-studies-uploaded/card-feasibility-study-select";
import Paginate from "@/components/paginate";
import { useEffect, useState } from "react";
import { useRouter } from "next/router";

export default function MyStudiesUploaded() {
  ...
  const DataHeader = {
    Title: i18n?.t("common:PurchasedDownloadedStudies"),
