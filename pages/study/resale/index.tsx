...
import FormResale from "@/components/study-sections/resale-sections/form-resale";

export default function ResaleFeasibilityStudy() {
  const DataHeader = {
    Title: i18n?.t("common:SliderTwoTitle"),
    Path: "/feasibility-study/resale",
    List: [
      {
